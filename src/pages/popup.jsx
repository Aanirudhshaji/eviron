              ...
              <div className="contact-popup-option-group">
                {["Web development", "Mobile App", "UI/UX", "Branding", "Other"].map((type) => (
                  <button
                    key={type}
                    type="button"
                    className={`contact-popup-option-btn ${
                      formData.projectType === type ? "contact-popup-option-btn-selected" : ""
                    }`}
              ...
              <div className="contact-popup-option-group">
                {["20K - 40K", "40K - 60K", "60K - 80K", "80K - 100K >"].map((range) => (
                  <button
                    ...
                    type="button"
                    className={`contact-popup-option-btn ${
                      formData.budget === range ? "contact-popup-option-btn-selected" : ""
                    }`}
              ...
              <div className="contact-popup-option-group">
                {["< 3 Month", "6 Month", "1 year"].map((time) => (
                  <button
                    ...
                    type="button"
                    className={`contact-popup-option-btn ${
                      formData.timeline === time ? "contact-popup-option-btn-selected" : ""
                    }`}
